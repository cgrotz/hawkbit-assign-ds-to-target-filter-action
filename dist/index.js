...
const api_1 = __webpack_require__(947);
function run() {
...
function getBasicAuthHeader() {
    ...
    const token = Buffer.from(`${tenant}\\${username}:${password}`).toString('base64');
    return `Basic ${token}`;
}
var AssignmentType;
(function (AssignmentType) {
    AssignmentType[AssignmentType["forced"] = 0] = "forced";
